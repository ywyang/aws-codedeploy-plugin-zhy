...
public class AWSCodeDeployPublisher extends Publisher implements SimpleBuildStep {
    ...
    private static final Regions[] AVAILABLE_REGIONS                 = {Regions.CN_NORTHWEST_1, Regions.CN_NORTH_1, Regions.AP_NORTHEAST_1, Regions.AP_SOUTHEAST_1, Regions.AP_SOUTHEAST_2, Regions.EU_WEST_1, Regions.US_EAST_1, Regions.US_WEST_2, Regions.EU_CENTRAL_1, Regions.US_WEST_1, Regions.SA_EAST_1, Regions.AP_NORTHEAST_2, Regions.AP_SOUTH_1, Regions.US_EAST_2, Regions.CA_CENTRAL_1, Regions.EU_WEST_2,  Regions.GovCloud};
